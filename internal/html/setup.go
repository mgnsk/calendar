...
func SetupPage(form url.Values, errs map[string]string) Node {
	return page("Setup", "", "", nil,
		Div(Class("max-w-3xl mx-auto"),
			Form(Class("text-center w-full sm:w-1/2 px-3 py-4 mx-auto"), Action("/setup"), Method("POST"),
				...
				Label(Class("block w-full pt-2"), For("base_url"), Text("Base URL")),
				input("base_url", "url", "Base URL", form.Get("base_url"), errs["base_url"], "mb-3"),
