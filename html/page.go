...
func Page(props PageProps) Node {
	return HTML5(HTML5Props{
		...
		Head: []Node{
			...
			Link(Rel("stylesheet"), Href(calendar.GetAssetPath("node_modules/@fontsource/inter/400.css"))),
			Link(Rel("stylesheet"), Href(calendar.GetAssetPath("node_modules/@fontsource/inter/400-italic.css"))),
